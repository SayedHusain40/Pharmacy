...
<option value="Baby Skin Care & Accessories">Baby Skin Care & Accessories</option>
    ...
    <button type="submit" name="ProductID" value="'. $productId.'" id="updateBtn" class="btn btn-primary" style="display: none;">Update</button>
    <button type="button" onclick="cancelEdit()" class="btn btn-secondary" id="cancelBtn" style="display: none;">Cancel</button>
</form>';
    } else {
        // Product not found
